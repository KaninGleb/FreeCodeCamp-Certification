...
// You likely know that it won't be exactly the same as working with HTML because of the way you
// apply classes to JSX elements.
//
// If you import styles from a stylesheet, it isn't much different at all. You apply a class to your JSX element
// using the className attribute, and apply styles to the class in your stylesheet. Another option is to apply
