...
//
// In HTML, almost all tags have both an opening and closing tag: <div></div>; the closing tag always has
// a forward slash before the tag name that you are closing. However, there are special instances in HTML called
// void elements, or elements that don’t require both an opening and closing tag before another element can start.
//
...
// and every element must be closed. The line-break tag, for example, must always be written as <br /> in order to be
// valid JSX that can be transpiled. A <div>, on the other hand, can be written as <div /> or <div></div>.
