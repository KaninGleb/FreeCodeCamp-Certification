...
// Then, in the renderOnline variable, map over the filtered array,
// and return a li element for each user that contains the text of their username.
...
class MyComponent extends Component {
  ...
  render() {
    ...
    const renderOnline = usersOnline.map((u, index) => {
      return <li key={index}>{u.username}</li> // Change this line
    })
