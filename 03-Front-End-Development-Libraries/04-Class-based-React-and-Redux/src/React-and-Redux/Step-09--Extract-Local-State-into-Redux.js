...
// the state management of your React messages app.
// Now that Redux is connected,
// you need to extract the state management out of the Presentational component and into Redux.
...
// that it dispatches submitNewMessage() from this.props, and pass in the current message input from local state as an argument.
...
// This example also illustrates how a component may have local state:
...
// However, as your apps become larger and more complex, so does your state management,
