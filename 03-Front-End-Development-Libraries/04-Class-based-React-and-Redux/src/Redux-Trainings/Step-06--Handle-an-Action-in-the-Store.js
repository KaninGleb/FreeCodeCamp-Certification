...
// Redux does not enforce state immutability, however,
// you are responsible for enforcing it in the code of your reducer functions. You'll practice this in later challenges.


// 🎯 Assignment
// The code editor has the previous example as well as the start of a reducer function for you.
// Fill in the body of the reducer function so that if it receives an action of type 'LOGIN' it returns a state
// object with login set to true. Otherwise, it returns the current state.
