...
// that then renders child components. You want these components to have access to some pieces of that state,
// which are passed in as props.
//
// For example, maybe you have an App component that renders a Navbar, among other components.
// In your App, you have state that contains a lot of user information,
