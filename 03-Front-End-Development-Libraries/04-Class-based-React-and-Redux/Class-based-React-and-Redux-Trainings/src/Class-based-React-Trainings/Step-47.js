...
// First, without doing this, your React apps would consist of a relatively empty HTML file and a large bundle of
// JavaScript when it's initially loaded to the browser.
...
// the initial page load contains all the page's markup, which can be crawled by search engines.
// Second, this creates a faster initial page load experience because the rendered HTML is smaller than
// the JavaScript code of the entire app.
