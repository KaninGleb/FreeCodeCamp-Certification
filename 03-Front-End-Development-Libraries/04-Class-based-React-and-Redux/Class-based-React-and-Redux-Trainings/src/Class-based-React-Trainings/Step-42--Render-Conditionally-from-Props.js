...
// (condition ? expressionIfTrue : expressionIfFalse) to make conditional decisions about what to render and when.
// However, there's one important topic left to discuss that lets you combine any or all
// of these concepts with another powerful React feature: props. Using props to conditionally render code
// is very common with React developers — that is,
...
// but you can see how several of the other concepts that were covered in the last few challenges might be
// just as useful in this context.
...
// So for 50/50 odds, use Math.random() >= .5 in your expression. Statistically speaking,
// this expression will return true 50% of the time, and false the other 50%. In the render method,
...
// In the Results component, write a ternary expression to render the h1 element with the
// text You Win! or You Lose! based on the fiftyFifty prop that's being passed in from GameOfChance.
// Finally, make sure the handleClick() method is correctly counting each turn so
// the user knows how many times they've played.
